...
try: 
	...
	for i in range(funcnum)[1:] :
		...
		print("Function:", params[0], end=' ') 
		print(" Type: ", end=' ') 
		print(util.func_types[params[1] & krui.FUNC_TYPE_MASK], end=' ')
		print(" i/o params: ", end=' ')
	...
	if not succ[0] :
		...
		print("Unit 1 has successor", succ[0], end=' ')
	...
	print("Next unit to the origin is unit", end=' ')
