...
int  kr_np_pattern(int mode ,int mode1 ,int pattern_no) {
    ...
    case PATTERN_GET:
        ...
        break;
    case PATTERN_DELETE:
        printf("PATTERN_DELETE");
        break;
    case PATTERN_MODIFY:
        printf("PATTERN_MODIFY");
        break;
    case PATTERN_SHOW:
        printf("PATTERN_SHOW");
        break;
    case PATTERN_NEW:
        printf("PATTERN_NEW");
        break;
    case PATTERN_DELETE_ALL:
        printf("PATTERN_DELETE_ALL");
        break;
    case PATTERN_SHUFFLE_ON:
        printf("PATTERN_SHUFFLE_ON");
        break;
    case PATTERN_SHUFFLE_OFF:
        printf("PATTERN_SHUFFLE_OFF");
        break;
    case PATTERN_VECTOR_NEW:
        printf("PATTERN_VECTOR_NEW");
        break;
    case PATTERN_ARRAY_ALLOC:
        printf("PATTERN_ARRAY_ALLOC");
        break;
    case PATTERN_SET_NUMBER:
        printf("PATTERN_SET_NUMBER");
        break;
    case PATTERN_GET_NUMBER:
        printf("PATTERN_GET_NUMBER");
        break;
    case PATTERN_SUB_SHUFFLE_ON:
        printf("PATTERN_SUB_SHUFFLE_ON");
        break;
    case PATTERN_SUB_SHUFFLE_OFF:
        printf("PATTERN_SUB_SHUFFLE_OFF");
        break;
    case GET_SHUFFLE_FLAG:
        printf("GET_SHUFFLE_FLAG");
        break;
    case GET_SUB_SHUFFLE_FLAG:
        printf("GET_SUB_SHUFFLE_FLAG");
        break;
    case SUBPATTERN_GET_NUMBER:
        printf("SUBPATTERN_GET_NUMBER");
        break;
    default:
        printf("%d", mode);
        break;
