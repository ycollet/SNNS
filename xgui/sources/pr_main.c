...
static void pr_setFunc(Widget w, int value, caddr_t call_data) {
    switch (value) {
    case 1:
        ui_xSetLabel(pr_prunFuncIcon,"     MagPruning      ");
        krui_setPrunFunc("MagPruning");
        break;
    case 2:
        ui_xSetLabel(pr_prunFuncIcon," OptimalBrainSurgeon ");
        krui_setPrunFunc("OptimalBrainSurgeon");
        break;
    case 3:
        ui_xSetLabel(pr_prunFuncIcon," OptimalBrainDamage  ");
        krui_setPrunFunc("OptimalBrainDamage");
        break;
    case 4:
        ui_xSetLabel(pr_prunFuncIcon,"   Skeletonization   ");
        krui_setPrunFunc("Skeletonization");
        break;
    case 5:
        ui_xSetLabel(pr_prunFuncIcon,"Noncontributing_Units");
        krui_setPrunFunc("Noncontributing_Units");
        break;

    case 6:
        ui_xSetLabel(pr_learnFuncIcon,"Std_Backpropagation");
        krui_setFFLearnFunc("Std_Backpropagation");
        break;
    case 7:
        ui_xSetLabel(pr_learnFuncIcon,"BackpropBatch");
        krui_setFFLearnFunc("BackpropBatch");
        break;
    case 8:
        ui_xSetLabel(pr_learnFuncIcon,"BackpropMomentum");
        krui_setFFLearnFunc("BackpropMomentum");
        break;
    case 9:
        ui_xSetLabel(pr_learnFuncIcon,"BackpropWeightDecay");
        krui_setFFLearnFunc("BackpropWeightDecay");
        break;
    case 10:
        ui_xSetLabel(pr_learnFuncIcon,"Quickprop");
        krui_setFFLearnFunc("Quickprop");
        break;
    case 11:
        ui_xSetLabel(pr_learnFuncIcon,"Rprop");
        krui_setFFLearnFunc("Rprop");
        break;
    case 12:
        ui_xSetLabel(pr_learnFuncIcon,"SCG");
