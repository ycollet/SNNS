...
void ui_displMap(Widget w, caddr_t call_data) {
    ...
    n++;
    XtSetArg(args[n], XtNwidth, 210);
    n++;
    XtSetArg(args[n], XtNheight, 25);
    n++;
    ...
    n++;
    XtSetArg(args[n], XtNhorizDistance, 30);
    n++;
    XtSetArg(args[n], XtNfromHoriz, setbutton);
    n++;
    ...
    n++;
    XtSetArg(args[n], XtNwidth,  MAP_windowsizeX+62);
    n++;
    XtSetArg(args[n], XtNheight, MAP_windowsizeY+62);
    n++;
    ...
    n++;
    XtSetArg(args[n], XtNfromVert, zoomin);
    n++;
    XtSetArg(args[n], XtNvertDistance, 10);
    n++;
    XtSetArg(args[n], XtNleft, XtChainLeft);
    n++;
...
static void ui_map_setup(Widget button, caddr_t call_data) {
    ...
    XtSetArg(args[n], XtNfromHoriz, NULL);
    n++;
    XtSetArg(args[n], XtNfromVert, done);
    n++;
    XtSetArg(args[n], XtNleft, XtChainLeft);
    n++;
    XtSetArg(args[n], XtNright, XtChainRight);
    ...
    XtSetArg(args[n], XtNborderWidth,  0);
    n++;
    XtSetArg(args[n], XtNfromHoriz,range_lab);
    n++;
    XtSetArg(args[n], XtNfromVert, range_lab);
    n++;
...
static void ui_map_geometry(int zoom_fact) {
    ...
    else if(disp_info.width < geo_info.width)
        XtResizeWidget(view,disp_info.width,
                       disp_info.height,view_info.border_width);
    else
