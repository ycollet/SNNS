...
void bn_createKOHONEN (void) {
    ...
    XtSetArg(arg[n],XtNminHeight,82);
    n++;
    XtSetArg(arg[n],XtNminWidth,254);
    n++;
    XtSetArg(arg[n],XtNmaxHeight,82);
    n++;
    XtSetArg(arg[n],XtNmaxWidth,254);
    n++;
...
static void errChk(krui_err ret) {
...
static void bn_kohonen_createNet(void) {
    int i,j,unit_no;
