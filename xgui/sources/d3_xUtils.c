...

{
    ...
    if (strcmp (name, "done") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         ...
                         done_bits, done_width, done_height));
        n++;
    }
    if (strcmp (name, "done2") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         done2_bits, done2_width, done2_height));
        n++;
    }
    if (strcmp (name, "control") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         control_bits, control_width, control_height));
        n++;
    }
    if (strcmp (name, "testL") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         testL_bits, testL_width, testL_height));
        n++;
    }
    if (strcmp (name, "setup") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         setup_bits, setup_width, setup_height));
        n++;
    }
    if (strcmp (name, "project") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         project_bits, project_width, project_height));
        n++;
    }
    if (strcmp (name, "links") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         links_bits, links_width, links_height));
        n++;
    }
    if (strcmp (name, "model") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         model_bits, model_width, model_height));
        n++;
    }
    ...
    if (strcmp (name, "units") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         units_bits, units_width, units_height));
        n++;
    }
    if (strcmp (name, "options") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         options_bits, options_width, options_height));
        n++;
    }
    if (strcmp (name, "freeze") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         freeze_bits, freeze_width, freeze_height));
        n++;
    }
    if (strcmp (name, "display") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         display_bits, display_width, display_height));
        n++;
    }
    ...
    if (strcmp (name, "reset") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         reset_bits, reset_width, reset_height));
        n++;
    }
    /*
        if (strcmp (name, "") == 0)
    ...
    */
    ...
    XtSetArg(arg[n], XtNborderWidth, 0);
    n++;
    XtSetArg(arg[n], XtNinternalHeight, 1);
    n++;
    XtSetArg(arg[n], XtNinternalWidth, 1);
    n++;

    XtSetArg(arg[n], XtNfromVert, top);
    n++;
    XtSetArg(arg[n], XtNfromHoriz, left);
    n++;
...

{
    ...
    if (strcmp (name, "parallel") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         parallel_bits, parallel_width, parallel_height));
        n++;
    }
    if (strcmp (name, "central") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         central_bits, central_width, central_height));
        n++;
    }
    if (strcmp (name, "on") == 0) {
        XtSetArg(arg[n], XtNbitmap,
    ...
    if (strcmp (name, "activation") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         activation_bits, activation_width, activation_height));
        n++;
    }
    if (strcmp (name, "initact") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         initact_bits, initact_width, initact_height));
        n++;
    }
    if (strcmp (name, "output") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         output_bits, output_width, output_height));
        n++;
    }
    if (strcmp (name, "bias") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         bias_bits, bias_width, bias_height));
        n++;
    }
    if (strcmp (name, "name") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         name_bits, name_width, name_height));
        n++;
    }
    if (strcmp (name, "number") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         number_bits, number_width, number_height));
        n++;
    }
    if (strcmp (name, "zvalue") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         zvalue_bits, zvalue_width, zvalue_height));
        n++;
    }
    ...
    if (strcmp (name, "size") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         size_bits, size_width, size_height));
        n++;
    }
    if (strcmp (name, "color") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         color_bits, color_width, color_height));
        n++;
    }
    if (strcmp (name, "color2") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         color2_bits, color2_width, color2_height));
        n++;
    }
    if (strcmp (name, "label") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         label_bits, label_width, label_height));
        n++;
    }
    if (strcmp (name, "toplabel") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         toplabel_bits, toplabel_width, toplabel_height));
        n++;
    }
    if (strcmp (name, "bottlabel") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         bottlabel_bits, bottlabel_width, bottlabel_height));
        n++;
    }
    if (strcmp (name, "freeze") == 0) {
        XtSetArg(arg[n], XtNbitmap,
    ...
    if (strcmp (name, "wire") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         wire_bits, wire_width, wire_height));
        n++;
    }
    ...
    if (strcmp (name, "small") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         small_bits, small_width, small_height));
        n++;
    }
    if (strcmp (name, "big") == 0) {
        XtSetArg(arg[n], XtNbitmap,
                 (Pixmap) XCreateBitmapFromData (ui_display,
                         XDefaultRootWindow (ui_display),
                         big_bits, big_width, big_height));
        n++;
    }

    XtSetArg(arg[n], XtNborderWidth, 0 /*!*/);
    n++;
    XtSetArg(arg[n], XtNradioGroup, group);
    n++;
    XtSetArg(arg[n], XtNinternalHeight, 1);
    n++;
    XtSetArg(arg[n], XtNinternalWidth, 1);
