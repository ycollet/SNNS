...
static void cc_selectActFuncCand(Widget w, int value, caddr_t call_data) {
    switch(value) {
    case ASYM_SIGMOID:
        ui_xSetLabel(cc_w10b,"Logistic");
        break;
    case SYM_SIGMOID :
        ui_xSetLabel(cc_w10b," LogSym ");
        break;
    case TANH        :
        ui_xSetLabel(cc_w10b," TanH   ");
        break;
    case RANDOM      :
        ui_xSetLabel(cc_w10b," Random ");
        break;
    case SINUS       :
        ui_xSetLabel(cc_w10b," Sinus  ");
        break;
    case EXPONENTIAL :
        ui_xSetLabel(cc_w10b," Gauss  ");
        break;
    }
...
static void cc_selectLearningFunc(Widget w, int value, caddr_t call_data) {
    switch(value) {
    case QUICKPROP        :
        ui_xSetLabel(cc_w11b," Quickprop ");
        break;
    case BACKPROP         :
        ui_xSetLabel(cc_w11b," Batch-BP  ");
        break;
    case RPROP            :
        ui_xSetLabel(cc_w11b,"   Rprop   ");
        break;
    case BACKPROP_ONLINE  :
        ui_xSetLabel(cc_w11b," Backprop  ");
    }
...
static void cc_selectPruneFunc(Widget w, int value, caddr_t call_data) {
    switch(value) {
    case SBC:
        ui_xSetLabel(cc_pfb," SBC ");
        break;
    case AIC:
        ui_xSetLabel(cc_pfb," AIC ");
        break;
    case CMSEP:
        ui_xSetLabel(cc_pfb,"CMSEP");
        break;
    }
