...

{
    ...
    */
    ...
    n++;
    XtSetArg(args[n], XtNinternalWidth, 5);
    n++;
    ...
    n++;
    XtSetArg(args[n], XtNinternalHeight, 0.99);
    n++;
    XtSetArg(args[n], XtNinternalWidth, 6);
    n++;
    XtSetArg(args[n], XtNfromVert, stepLabel);
    n++;
    ...
    n=0;
    XtSetArg(args[n], XtNvertDistance, -2);
    n++;
...
void ui_NumberOfLearnParamsChanged(void) {
    ...
    n++;
    XtSetArg(args[n], XtNmappedWhenManaged, TRUE);
    n++;
    for(i=0; i < in; i++) {
