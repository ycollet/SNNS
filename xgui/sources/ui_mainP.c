...
void ui_jog_on(Widget w, caddr_t client_data, caddr_t call_data) {
    ...
    XtSetArg(args[n], XtNforeground, &fore);
    n++;
    XtSetArg(args[n], XtNbackground, &back);
    n++;
    ...
    if(ui_jogFlg) {
        XtSetArg(args[n], XtNbackground, fore);
        n++;
        XtSetArg(args[n], XtNforeground, back);
        n++;
    } else {
        XtSetArg(args[n], XtNbackground, back);
        n++;
...

{
    ...
    n = 0;
    XtSetArg(args[n], XtNfromHoriz, button );
    n++;
...

{
    ...
    n++;
    XtSetArg(args[n], XtNfromVert, sbutton);
    n++;
    XtSetArg(args[n], XtNleft, XtChainLeft);
    n++;
    XtSetArg(args[n], XtNright, XtChainLeft);
...

{
    ...
    n = 0;
    XtSetArg(args[n], XtNwidth,  displayPtr->width);
    n++;
    XtSetArg(args[n], XtNheight, displayPtr->height);
    n++;
    XtSetArg(args[n], XtNfromVert, fbutton);
    n++;
    XtSetArg(args[n], XtNleft, XtChainLeft);
    n++;
...

{
    ...
    if (start != end) {
        ...
        n = 0;
        XtSetArg(args[n], XtNtextSource, &src);
        n++;
...

{
    ...
    n = 0;
    XtSetArg(args[n], XtNwidth,  575);
    n++;
    XtSetArg(args[n], XtNheight, 400);
    n++;
    XtSetArg(args[n], XtNtype, XawAsciiFile);
    n++;
    XtSetArg(args[n], XtNstring, hdoc);
    n++;
    XtSetArg(args[n], XtNscrollVertical, XawtextScrollAlways);
    n++;
    XtSetArg(args[n], XtNfromVert, doneButton);
    n++;
    XtSetArg(args[n], XtNfromHoriz, NULL);
    n++;
    XtSetArg(args[n], XtNleft, XtChainLeft);
