/*
 * File:     (%W%    %G%)
 * Purpose:  declaration of input history functions
 *
 *    
 *           #######     #     #     #######      #####  
 *           #           ##    #          #      #     #
...
#ifndef _HISTINPUTS_H
#define  _HISTINPUTS_H


int   histInputs_init  ( ModuleTableEntry *self, int msgc, char *msgv[] );
int   histInputs_work  ( PopID *parents, PopID *offsprings, PopID *reference);
