/*
 * File:    (%W%    %G%)
 * Purpose: declaration of histFitness routines.
 *
 *
 *           #######     #     #     #######      #####
 *           #           ##    #          #      #     #
...
#ifndef _HISTFITTNESS_H
#define _HISTFITTNESS_H

int   histFitness_init  ( ModuleTableEntry *self, int msgc, char *msgv[] );
int   histFitness_work  ( PopID *parents, PopID *offsprings, PopID *reference);
