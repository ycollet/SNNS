/*
 * File:    (%W%    %G%)
 * Purpose: declaration of histDetails routines.  
 *
 *    
 *           #######     #     #     #######      #####  
 *           #           ##    #          #      #     #
...
#ifndef _HISTDETAILS_H
#define _HISTDETAILS_H


int   histDetails_init  ( ModuleTableEntry *self, int msgc, char *msgv[] );
int   histDetails_work  ( PopID *parents, PopID *offsprings, PopID *reference);
