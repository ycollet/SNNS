/*
 * File:     (%W%    %G%)
 * Purpose:  declaration of histWeights routines
 *
 *
 *           #######     #     #     #######      #####
 *           #           ##    #          #      #     #
...
#ifndef _HISTWEIGHTS_H
#define _HISTWEIGHTS_H

int   histWeights_init  ( ModuleTableEntry *self, int msgc, char *msgv[] );
int   histWeights_work  ( PopID *parents, PopID *offsprings, PopID *reference);
