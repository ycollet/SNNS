/*
 * File:     (%W%    %G%)
 * Purpose:  declaration of learn rating evaluation functions
 *
 *    
 *           #######     #     #     #######      #####  
 *           #           ##    #          #      #     #
...
#ifndef __LEARN_RATING__
#define __LEARN_RATING__



int   learnRating_init  ( ModuleTableEntry *self, int msgc, char *msgv[] );
int   learnRating_work  ( PopID *parents, PopID *offsprings, 
		          PopID *reference );
