/*
 * File:     (%W%    %G%)
 * Purpose:  declarartion of topology (rating) evaluation functions
 *
 *    
 *           #######     #     #     #######      #####  
 *           #           ##    #          #      #     #
...
#ifndef _TOPO_RATING_H
#define _TOPO_RATING_H
int   topologyRating_init  ( ModuleTableEntry *self, int msgc, char *msgv[] );
int   topologyRating_work  ( PopID *parents, PopID *offsprings, 
			     PopID *reference );
