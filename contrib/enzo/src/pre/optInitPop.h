...
#ifndef _OPTINITPOP_H
#define _OPTINITPOP_H

extern int   optInitPop_init   (ModuleTableEntry *self, int msgc, char *msg[] );
extern int   optInitPop_work   (PopID *parent,PopID *offsprings,
				PopID *reference);
extern char *optInitPop_errMsg (int err_code);
