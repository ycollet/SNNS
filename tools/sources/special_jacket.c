...
void print(arglist_type *arglist) {
    ...
    while (arglist != ARG_NULL) {
        ...
        switch(type) {
        case INT:
            fprintf(log_file,"%d", val.int_val);
            break;
        case REAL:
            fprintf(log_file,"%g", val.real_val);
            break;
        case BOOL:
        ...
        case STRING:
            ...
            break;
        case UNKNOWN:
            fprintf(log_file,"<undef>");
            break;
        default:
            err_prt("Cannot print this");
        }
...
void execute(arglist_type *arglist) {
        ...
        /* scanner returns 0 on end of line */
    {
        ...
        case STRING:
            ...
            break;
        default:
            err_prt("Error parsing shell command's output");
        }
        arglist = arglist->next;
    }
