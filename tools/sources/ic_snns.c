...
void setCascadeParams(arglist_type *arglist) {
    ...
    if (arglist != ARG_NULL) {
        ...
        else if (strcmp(val.string_val, "Backprop") == 0)
            learn_param_array[7] = BACKPROP;
        else if (strcmp(val.string_val, "Rprop") == 0)
    ...
    if (arglist != ARG_NULL) {
        ...
        else if (strcmp(val.string_val, "AIC") == 0)
            learn_param_array[20] = AIC;
        else if (strcmp(val.string_val, "CMSEP") == 0)
    ...
    if (arglist != ARG_NULL) {
        ...
        else if (strcmp(val.string_val, "Act_LogSym") == 0)
            learn_param_array[13] = SYM_SIGMOID;
        else if (strcmp(val.string_val, "Act_TanH") == 0)
            learn_param_array[13] = TANH;
        else if (strcmp(val.string_val, "Act_Random") == 0)
...
void saveResult(arglist_type *arglist) {
    ...
    if (arglist != ARG_NULL) {
        ...
        if (strcmp(val.string_val, "append") == 0)
            create = FALSE;
        else if (strcmp(val.string_val, "create") != 0)
            warn_prt
